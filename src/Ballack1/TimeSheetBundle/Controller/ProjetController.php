...
class ProjetController extends Controller
{
    ...
    public function mesProjetAction()
    {
        ...
        //$projets = $em->getRepository('BallackTimeSheetBundle:Projet')->findByEmployes(array($emp));
        ...
        return $this->render('BallackTimeSheetBundle:projet:myProjet.html.twig', array(
            'projets' => $emp->getProjets(),
        ));
    }
    ...
    public function showAction(Projet $projet)
    {
        ...
        $projets = $em->getRepository('BallackTimeSheetBundle:Projet')->getNombreHeureWorkByProjet($projet);
        $activites = $em->getRepository('BallackTimeSheetBundle:Activite')->findAllActiviteByProjet($projet);
        foreach ($activites as $act) {
            $nbre+= $util->to_seconds($act->getTimestop()->diff($act->getTimestart()));

        }
        return $this->render('BallackTimeSheetBundle:projet:show.html.twig', array(
            'projet' => $projet, 'allTimes' => $projets, 'nbre' => $nbre/3600,
